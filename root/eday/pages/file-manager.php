...
$xp=['<a href="'.site::url.'?'.EDAY_ADMIN_KEY.'=file/manager">www</a>'];
foreach($eps as $ep){
  $xpp[]=$ep;
  $xp[]='<a href="'.site::url.'?'.EDAY_ADMIN_KEY.'=file/manager/'
...
if($f->type=='directory'){
  ...
  $filename='<a href="'.site::url.'?'.EDAY_ADMIN_KEY.'=file/manager/'
...
<script type="text/javascript" src="<?=admin::appURL('js/file.js')?>"></script>

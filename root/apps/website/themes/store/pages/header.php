...
?><!DOCTYPE html><html lang="en-US"><head>
  ...
  <link rel="preload" type="font/truetype" href="<?=site::url?>apps/website/themes/store/fonts/segoeuil.ttf" />
  <link rel="preload" type="font/truetype" href="<?=site::url?>apps/website/themes/store/fonts/neuropol.ttf" />
  <link rel="preload" type="text/css" href="<?=site::url?>apps/website/themes/store/css/index.min.css" as="style" />
